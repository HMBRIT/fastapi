...
def salesReportMain():
    ...
    def create_prmst(zid):
        ...
        engine = create_engine('postgresql://postgres:postgres@192.168.1.100:5432/da')
    ...
    writer2 = pd.ExcelWriter('HmbrSalesRatios.xlsx')
    ...
    you = ["asaddat87@gmail.com","mo.hmbrbd@gmail.com","saleshmbrbd@gmail.com","hmbr12@gmail.com", "ithmbrbd@gmail.com"]
